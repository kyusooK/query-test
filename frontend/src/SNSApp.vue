...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'GetInventory', 
                description: 'getInventory을 관리하는 화면입니다.', 
                key: 'getInventories', 
                route: '/inventories/getInventories',
                ImageUrl: '',
            },
            { 
                title: 'StockHistory', 
                description: 'stockHistory을 관리하는 화면입니다.', 
                key: 'stockHistories', 
                route: '/inventories/stockHistories',
                ImageUrl: '',
            },
